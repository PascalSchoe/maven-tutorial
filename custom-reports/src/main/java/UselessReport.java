...
@Mojo(name = "uselessreport", defaultPhase = LifecyclePhase.SITE, requiresDependencyResolution = ResolutionScope.RUNTIME, requiresProject = true, threadSafe = true)
public class UselessReport extends AbstractMavenReport{
	public String getOutputName() {
		// This report will generate simple-report.html when invoked in a
		// project with `mvn site`
		return "uselessreport";
	}

	public String getName(Locale locale) {
		// Name of the report when listed in the project-reports.html page of a
		// project
		return "Useless Report";
	}

	public String getDescription(Locale locale) {
		// Description of the report when listed in the project-reports.html
		// page of a project
		return "This useless report is a very simple report that does nothing but "
	...
	protected void executeReport(Locale locale) throws MavenReportException {
		...
		mainSink.head();
		mainSink.title();
		mainSink.text("Useless Report for " + project.getName() + " " + project.getVersion());
		mainSink.title_();
		mainSink.head_();
